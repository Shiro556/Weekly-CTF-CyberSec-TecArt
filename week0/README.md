...
Dokumentasi Py : ![Foto Dokumentasi](2.png)
...
Penjelasan: ExifTool adalah aplikasi berbasis command-line (baris perintah) gratis dan open-source yang digunakan untuk membaca, menulis, dan mengedit metadata pada berbagai macam file, terutama file 
gambar, foto, audio, dan video

Dokumentasi hasil pengerjaan: ![Foto Dokumentasi](4.png)
